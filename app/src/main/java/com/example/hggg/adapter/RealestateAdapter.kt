...
import com.example.hggg.databinding.ItemRealestateBinding
import com.example.hggg.model.AddOnClick

class RealestateAdapter(private val listener: AddOnClick) : RecyclerView.Adapter<RealestateAdapter.ViewHolder>() {
    ...
    class ViewHolder(var binding: ItemRealestateBinding, private val listener: AddOnClick) : RecyclerView.ViewHolder(binding.root) {
