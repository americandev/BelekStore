...
class StoreAdapter(private val listener: AddOnClick) : RecyclerView.Adapter<StoreAdapter.ViewHolder>() {
    ...
    class ViewHolder(var binding: ItemCarBinding, private val listener: AddOnClick) : RecyclerView.ViewHolder(binding.root) {
