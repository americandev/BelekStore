...
import com.example.hggg.databinding.ItemPlantsBinding
import com.example.hggg.model.AddOnClick

class PlantsAdapter(private val listener: AddOnClick) : RecyclerView.Adapter<PlantsAdapter.ViewHolder>() {
    ...
    class ViewHolder(var binding: ItemPlantsBinding, private val listener: AddOnClick) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PlantsAdapter.ViewHolder {
        ...
        return PlantsAdapter.ViewHolder(binding, listener)
    }

    override fun onBindViewHolder(holder: PlantsAdapter.ViewHolder, position: Int) {
