...
import com.example.hggg.databinding.FragmentLaptopsBinding
import com.example.hggg.laptops.laptopsViewModel
import com.example.hggg.model.AddOnClick
import com.example.hggg.ui.home.HomeViewModel

class laptopsFragment : Fragment(), AddOnClick {

    private var _binding: FragmentLaptopsBinding? = null
    private val binding get() = _binding!!

    private val vm: laptopsViewModel by viewModels()

    //private lateinit var viewModel: laptopsViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        vm.bodyTypes.observe(viewLifecycleOwner, {
            val adapter = LaptopsAdapter(this)
